...
namespace GerirAluguel.Controllers
{
    ...
    public class ImoveisController : ControllerBase
    {
        ...
        public ImoveisController(ImovelServices service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] ImoveisDto dto)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, [FromBody] ImoveisDto dto)
        {
